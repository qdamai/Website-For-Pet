  ...
  <nav class="neo-navbar">
    <div class="container navbar-container">
      ...
      <div class="nav-menu" :class="{ 'is-active': isMobileMenuOpen }">
        ...
        <router-link to="/dashboard" class="nav-item-icon" @click="closeMobileMenu">
          <LayoutDashboard :size="24" class="nav-icon" />
          <span class="nav-icon-text">{{ langStore.t('dashboard') }}</span>
        </router-link>
        <router-link to="/radar" class="nav-item-icon" @click="closeMobileMenu">
          <Radar :size="24" class="nav-icon" />
          <span class="nav-icon-text">{{ langStore.t('radar') }}</span>
        </router-link>
        <router-link to="/explore" class="nav-item-icon" @click="closeMobileMenu">
          <Search :size="24" class="nav-icon" />
          <span class="nav-icon-text">{{ langStore.t('explore') }}</span>
        </router-link>
        <router-link to="/report" class="nav-item-icon" @click="closeMobileMenu">
          <FileText :size="24" class="nav-icon" />
          <span class="nav-icon-text">{{ langStore.t('report') }}</span>
        </router-link>
        <router-link to="/chat" class="nav-item-icon" @click="closeMobileMenu">
          <MessageSquare :size="24" class="nav-icon" />
          <span class="nav-icon-text">{{ langStore.t('chat') }}</span>
        </router-link>
